<!--==============================
    Breadcumb
    ============================== -->
<div class="breadcumb-wrapper" data-bg-src="url(assets/images/contact/contact-hero.jpg)">
    <!-- bg animated image/ -->
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
...
<div class="contact-area">
    <div class="container container2">
        <div class="row justify-content-center align-items-top">
            ...
            <div class="col-md-6 contact-info-img">
                <img style="width: 100%; height: 100%;" src="assets/images/contact/contact1.jpg" alt="Contact Img" style="width: 100%; height: 100%;">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="contact-map-sec">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1549.3983416194774!2d88.51578868365652!3d22.537511944063926!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a020b759875957f%3A0x1893a441ee5b2bff!2sBeonta%20II%20Gram%20Panchayet%20Office!5e0!3m2!1sen!2sin!4v1722578590636!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="contact-form-wrap ms-xl-4 mt-40 mt-lg-0">
                    ...
                    <div id="modalForm">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <select name="isd_code1" id="isd_code1" class="form-select style-border" style="margin: 0; padding: 0; padding-left: 5px;" required>
                                    ...
                                    <label data-default-mssg="" class="input_alert isd_code1-inp-alert"></label>
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div class="form-group">
