...
<!--==============================
    Counter Area  
    ==============================-->
<div class="counter-area-2 space overflow-hidden" data-bg-src="url(assets/img/bg/counter-2-1-bg.jpg)">
            ...
            <div class="col-sm-6 col-lg-auto">
                <div class="counter-card style2">
                    <div class="counter-card-icon">
                        <svg version="1.1" id="Layer_1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                            y="0px" viewBox="0 0 122.88 97.15" style="enable-background:new 0 0 122.88 97.15"
                            xml:space="preserve">
                            <g>
                                <path
...
<!--==============================
    ...
    ==============================-->
<div class="container container2">
    <div class="why-area-2 overflow-hidden bg-smoke " data-pos-for=".counter-area-2"
        data-sec-pos="top-half">
        <div class="row justify-content-end">
            <div class="col-md-6">
                <div>
                    <img src="assets/images/basbhumi/basbhumi_plan.jpg" class="why-bg-img-1" alt="Bashbhumi Plan"
                        id="myImg">
                </div>
            </div>
            <div class="col-md-6">
...
<!--==============================
        Process Area  
    ==============================-->
<div class="row space-top justify-content-center">
    <div class="col-xl-7 col-lg-8">
        <div class="title-area text-center">
            <h2 class="sec-title">NEAR BY LOCATIONS</h2>
            <span class="sub-title">Experience seamless access to essential services and transportation.</span>
        </div>
    </div>
</div>
                    ...
                    <div class="description">
                        <div class="title">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision"
                                ...
                                fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 512 481.75" width="40px"
        ...
        <div class="content">
            <div class="back">
                <div class="back-content">
                    <svg xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision"
                        text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd"
                        clip-rule="evenodd" viewBox="0 0 512 181.81" fill="white" width="60px" height="">
                        <path
...
<!--Site Location  -->
<div class="container">
    <h2 class="title-area text-center sec-title">Site Location</h2>
    <div class="container container3">
        <div class="why-area-2 overflow-hidden bg-smoke position-relative" data-pos-for=".counter-area-2">
            <div>
                <img src="assets/images/basbhumi/basbhumi_map_location.jpg" class="why-bg-img-1"
                    alt="Bashbhumi Plan" id="myImg1">
            </div>
            <div class="row justify-content-end">
