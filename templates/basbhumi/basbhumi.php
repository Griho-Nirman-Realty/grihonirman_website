...
<div class="container container2">
    ...
    <div class="why-area-2  overflow-hidden bg-smoke " data-pos-for=".counter-area-2" data-sec-pos="top-half">
...
<!--==============================
        Process Area  
    ==============================-->
<div class="row m-0 nearby space justify-content-center ">
    <div>
...
<div class="container container2">
    <div class="why-area-2 overflow-hidden bg-smoke" data-pos-for=".counter-area-2" >
        <div class="fixed-size-image">
            <img src="assets/images/basbhumi/basbhumi_map_location.jpg" class="why-bg-img-1" alt="Bashbhumi Location" id="myImg1">
        </div>
        <div class="row justify-content-end">
            <div class="col-xl-6 col-lg-7">
                <div class="why-wrap">
