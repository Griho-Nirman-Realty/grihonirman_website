        ...
        (e.min = 1),
            ...
            (e.prototype.init = function (t) {
                ...
                (i.$minus = !1),
                    ...
                    (i.value = t.attr("value")==undefined ? 1 : parseInt(t.attr("value"))),
                    i.min || t.attr("min", (i.min = e.min)),
                    i.max || t.attr("max", (i.max = e.max)),
                    (i.$value = t.val((i.value = i.value))),
                    (i.$minus = t
                        .parent()
                        .find(".quantity-minus")
    ...
    (function (t) {
        ...
        (e.prototype.init = function (e) {
            ...
            (o.$wrapper = e),
                ...
                "complete" === Wolmart.status && (Wolmart.slider(s, { thumbs: { swiper: o.$thumbsWrap.data("slider") } }), 
