...
if (file_exists("templates/" . $pg_nm . "/page_details/query.php")) {
	include("templates/" . $pg_nm . "/page_details/query.php");
}
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					...
					<div class="d-flex flex-column">
						<a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary"><?php echo $session_name; ?></a>
