                            ...
                            <center>
                                <div class="image-input image-input-outline" id="kt_image_1">
                                    <div style="width: auto; height:auto; margin-top:10px;" class="image-input-wrapper">
                                        <img loading="lazy"  style="max-width: 150px;" alt="image" class="logo" data-blank-image="../upload_content/upload_img/no_image.png" src="../upload_content/upload_img/<?php echo $logo == "" ? "no_image.png" : "system_img/" . $logo; ?>" />
                                    </div>
                                </div>
                            </center>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <center>
                                <div class="image-input image-input-outline" id="kt_image_1">
                                    <div style="width: auto; height:auto; margin-top:10px;" class="image-input-wrapper">
                                        <img loading="lazy"  style="max-width: 150px;" alt="image" class="favicon" data-blank-image="../upload_content/upload_img/no_image.png" src="../upload_content/upload_img/<?php echo $favicon == "" ? "no_image.png" : "system_img/" . $favicon; ?>" />
                                    </div>
                                </div>
                            </center>
