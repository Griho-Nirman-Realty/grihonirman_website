...
function chngMode(mode) {
	if (mode=="Update") {
		_(".entry_modal_title").innerHTML = 'Update User Mode Details :';
		_(".save_btn").innerHTML = 'Update Data';
	}
	else{
		_(".entry_modal_title").innerHTML = 'Enter User Mode Details :';
...
function save_details(){
	...
	if(!_("#user_mode").checkValidity()){
		toastr['warning']("User Mode : "+_("#user_mode").validationMessage, "WARNING");
